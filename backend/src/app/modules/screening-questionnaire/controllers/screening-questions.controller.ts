...
@SetMetadata('entityModel', ScreeningQuestion)
export class ScreeningQuestionsController extends BaseController<ScreeningQuestion> {
    override className: string = this.constructor.name;

    constructor(protected service: ScreeningQuestionsService,
    ...
    async getByFormId(
        ...
        try {
            console.log('Screening Questions Controller', formId);
            const questions = await this.service.getByFormIdAsync(new ObjectId(formId));
            console.log('Questions by form id:', questions);
