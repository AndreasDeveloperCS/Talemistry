...
@Controller('opportunities-managers') // Opportunity Guide  - Opportunity Coordinator -  Opportunity Matchmaker- Talent Matchmaker - Talent Scout - Talent Hunter - Talent Seeker 
@SetMetadata('entityModel', Manager)
export class OpportunitiesManagerController extends BaseController<Manager> {
    override className: string = this.constructor.name;
    constructor(protected service: OpportunitiesManagersService,
