...
@Schema({ collection: 'blogs-favorite' })
@Entity("blogs-favorite")
...
export class BlogFavorite implements IBaseModel, IVerifiableModel, IAuditCreated, IAuditModified {
...
export type BlogFavoriteDocument = BlogFavorite & Document;

export const BlogFavoriteSchema = SchemaFactory.createForClass(BlogFavorite);