...
import { IndustrySubGroup } from '../models/industry-subgroup';
import { IndustrySubGroupService } from '../services/industry-subgroups.service';

@Controller('industry-subgroups')
@SetMetadata('entityModel', IndustrySubGroup)
export class IndustrySubGroupController extends BaseController<IndustrySubGroup> {
    override className: string = this.constructor.name;

    constructor(protected service: IndustrySubGroupService,
