...
@SetMetadata('entityModel', FunctionalBlock)
export class FunctionalBlocksController extends BaseController<FunctionalBlock> {
    override className: string = this.constructor.name;

    constructor(protected service: FunctionalBlocksService,
