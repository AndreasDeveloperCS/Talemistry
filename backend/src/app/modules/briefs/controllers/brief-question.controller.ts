...
import { BriefQuestion } from "../models/brief-question";
import { BriefQuestionService } from "../services/brief-question.service";
import { ModuleRef } from "@nestjs/core";

@Controller('brief-questions')
@SetMetadata('entityModel', BriefQuestion)
export class BriefQuestionTemplateController extends BaseController<BriefQuestion> {

    override className: string = this.constructor.name;

    constructor(
        protected briefService: BriefQuestionService,
