...
import { BriefSectionTemplate } from "../models/brief-template-section";
import { BriefSectionTemplateService } from "../services/brief-section.service";
import { ModuleRef } from "@nestjs/core";

@Controller('brief-sections')
@SetMetadata('entityModel', BriefSectionTemplate)
export class BriefSectionTemplateController extends BaseController<BriefSectionTemplate> {

    override className: string = this.constructor.name;

    constructor(
        protected briefService: BriefSectionTemplateService,
