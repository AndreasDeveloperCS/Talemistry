...
@Controller('live-coding-sessions')
@SetMetadata('entityModel', LiveCodingSession)
export class LiveCodingSessionController extends BaseController<LiveCodingSession> {

  constructor(protected service: LiveCodingSessionService, protected moduleRef: ModuleRef) {
