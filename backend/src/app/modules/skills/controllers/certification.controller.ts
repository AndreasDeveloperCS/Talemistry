...
@Controller('professional-certifications')
@SetMetadata('entityModel', Certification)
export class CertificationController extends BaseController<Certification> {

    constructor(protected service: CertificationService, protected moduleRef: ModuleRef) {
