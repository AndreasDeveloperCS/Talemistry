...
@Schema({ collection: 'professional-certification' })
@Entity("professional-certification")
...
export class Certification implements IBaseModel, IVerifiableModel, IAuditCreated, IAuditModified, IOwnerModel {
