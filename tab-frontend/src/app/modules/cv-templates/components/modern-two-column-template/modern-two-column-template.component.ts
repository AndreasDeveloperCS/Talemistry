...
@Component({
  selector: 'app-modern-two-column-template',
  templateUrl: './modern-two-column-template.component.html',
  styleUrl: './modern-two-column-template.component.scss',
  standalone: false,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ModernTwoColumnTemplateComponent implements OnInit, OnDestroy {
