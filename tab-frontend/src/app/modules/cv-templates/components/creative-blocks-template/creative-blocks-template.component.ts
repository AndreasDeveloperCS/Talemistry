...
@Component({
  selector: 'app-creative-blocks-template',
  templateUrl: './creative-blocks-template.component.html',
  styleUrl: './creative-blocks-template.component.scss',
  standalone: false,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CreativeBlocksTemplateComponent implements OnInit, OnDestroy {
