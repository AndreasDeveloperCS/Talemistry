...
@Component({
  selector: 'app-minimalist-single-template',
  templateUrl: './minimalist-single-template.component.html',
  styleUrl: './minimalist-single-template.component.scss',
  standalone: false,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MinimalistSingleTemplateComponent implements OnInit, OnDestroy {
