...
@Component({
  selector: 'app-social-network-platforms',
  templateUrl: './social-network-platforms.component.html',
  styleUrl: './social-network-platforms.component.scss',
  standalone: false,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SocialNetworkPlatformsComponent {
