...
@Component({
  selector: 'app-opened-position-short-item',
  templateUrl: './opened-position-short-item.component.html',
  styleUrl: './opened-position-short-item.component.scss',
  standalone: false,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class OpenedPositionShortItemComponent {
  @Input()
  ...
  async deleteOpenedPosition(positionId: any) {
    this.service.deleteOpenedPosition(positionId);
    this.positionsListUpdated.emit(true);
  }

  async editOpenedPosition(positionId: any) {
