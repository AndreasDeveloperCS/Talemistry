...
const pipeline_gateway_1 = require("./pipeline.gateway");
...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        providers: [pipeline_gateway_1.PipelineGateway, collaboration_gateway_1.CollaborationGateway, signaling_gateway_1.SignalingGateway],
        exports: [pipeline_gateway_1.PipelineGateway, collaboration_gateway_1.CollaborationGateway, signaling_gateway_1.SignalingGateway],
    })
], RealtimeModule);
